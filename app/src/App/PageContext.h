...
//
//     grep -ohE '"(dev|adv|svc|upd|conn|onb)_[a-z0-9_]+"' app/src/App/*.cpp | sort -u
//
...
// tray tooltip. onb_ is onboarding, Phase E5: the tray balloon and the
// Connect-button TeachingTip.)
//
