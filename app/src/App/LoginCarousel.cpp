...
#include "ConnectorGlyph.h"  // the ur connector outline, shared with the hero and the share code
...
// own 32x32 box, from ConnectorGlyph.h -- the one copy of the outline this app
// keeps. Path.Stretch scales it to the slot, and filling it with an ImageBrush
// is how the image gets clipped to the globe — iOS does the same thing with
// .mask(Image("ur.symbols.globe")).
